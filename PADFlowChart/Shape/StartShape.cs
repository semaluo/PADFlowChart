...
{
    [Serializable]
    public class StartShape : AbstractFlowChartShape
    {
        private Connector m_leftConnector;

        public StartShape() : base()
        {
            Init();
        }
        ...
        protected StartShape(SerializationInfo info, StreamingContext context) : base(info, context)
        {
